...
int altaMicro(eMicro micros[], int tam, int* pId, eEmpresa empresas[], int tamE, eTipo tipos[], int tamT)
{
    int todoOk = 0;
    int indice;
    char auxCad[100];
...
int listarMicros(eMicro micros[], int tam, eEmpresa empresas[], int tamE, eTipo tipos[], int tamT)
{
    int todoOk = 0;
    int flag=0;
    ...
    if(micros!= NULL && tam>0)
    {
        ...
        for(int i=0; i < tam; i++)
        {
            if(!micros[i].isEmpty)
            {
                mostrarMicro(micros[i], empresas, tamE, tipos, tamT);
...
int mostrarMicro(eMicro micros, eEmpresa empresas[], int tamE, eTipo tipos[], int tamT)
{
    int todoOk = 0;
    char descEmpresa[20];
    char descTipos[20];
    ...
    printf("  %4d    %s    %s    %d\n", micros.id, descEmpresa, descTipos, micros.capacidad);
        todoOk = 1;
    }
    return todoOk;
}

int modificarMicro(eMicro micros[], int tam, eTipo tipos[], int tamT, eEmpresa empresas[], int tamE)
{
    int todoOk = 0;
    int indice;
    int id;
    ...
    if(micros!= NULL && tam > 0)
    {
        listarMicros(micros, tam, empresas, tamE, tipos, tamT);
        printf("Ingrese Id: ");
        scanf("%d", &id);
...
int bajaMicro(eMicro micros[], int tam, eEmpresa empresas[], int tamE, eTipo tipos[], int tamT)
{
    int todoOk = 0;
    int indice;
    int id;
